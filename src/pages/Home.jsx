      ...
      <section id="contact" className="section bg-gray-50">
        <div className="container-slim">
          ...
          {isEn ? (
            ...
            <div className="mt-2 text-gray-700">
              <p className="text-gray-600">บริษัท อี.เอส.เอ็ม. โซลูชัน จำกัด สาขาอาคารชาญอิสสระทาวเวอร์</p>
              <p className="mt-2">942/88 อาคารชาญอิสสระทาวเวอร์ ชั้น 3 ถนนพระราม 4 แขวงสุริยวงศ์ เขตบางรัก กรุงเทพฯ 10500</p>
